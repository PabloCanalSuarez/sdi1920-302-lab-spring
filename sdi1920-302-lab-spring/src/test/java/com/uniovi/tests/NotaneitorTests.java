...
public class NotaneitorTests {
	...
	public void PR10() {
		...
		PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
		// Rellenamos el formulario
		PO_LoginView.fillForm(driver, "99999990A", "123");
		// COmprobamos que entramos en la pagina privada de Alumno
	...
	public void PR11() {
		...
		// Comprobamos que hemos salido
		PO_View.checkElement(driver, "text", "Identifícate");
	}

	// PR12. Loguearse, comprobar que se visualizan 4 filas de notas y
	// desconectarse usando el rol de estudiante.
	@Test
	public void PR12() {		
	...
	public void PR15() {
		...
		PO_PrivateView.listNotasAndDeleteLast(driver, "Nota Nueva 1");
